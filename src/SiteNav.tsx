...
export const SiteNav = () => {
  return (
    <nav className="flex flex-row justify-between md:grid grid-cols-3 grid-rows-1 gap-2 items-center fixed top-0 w-full border-b-2 border-brand-gray-50 p-2 bg-white z-100">
